...
def depth_limited_search(initial_state, actions, depth):
    if depth==0 :
        return 'Incomplete'
    ...
    for action in actions:
        new_state=action_taken(initial_state,action)
        result=depth_limited_search(new_state,actions,depth-1)
...
depth_limit = 1
x=depth_limited_search(initial_state,actions,depth_limit)
print(x)